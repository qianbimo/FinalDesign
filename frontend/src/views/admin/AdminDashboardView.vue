...
<template>
  <div v-loading="loading">
    <el-row :gutter="16">
      ...
      <el-col :xs="24" :sm="12" :lg="6"><el-card>患者人数：{{ dashboard.patientUsers || 0 }}</el-card></el-col>
      <el-col :xs="24" :sm="12" :lg="6"><el-card>医生人数：{{ dashboard.doctorUsers || 0 }}</el-card></el-col>
      <el-col :xs="24" :sm="12" :lg="6"><el-card>管理员人数：{{ dashboard.adminUsers || 0 }}</el-card></el-col>
    </el-row>
    ...
    <el-row :gutter="16" style="margin-top: 16px">
      ...
      <el-col :xs="24" :sm="12" :lg="6"><el-card>智能分析任务总数：{{ dashboard.totalAiTasks || 0 }}</el-card></el-col>
