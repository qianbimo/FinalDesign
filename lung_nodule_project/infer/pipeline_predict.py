...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--seg_ckpt", type=str, default="workspace/weights/seg_best.pth")
    parser.add_argument("--cls_ckpt", type=str, default="workspace/weights/cls_best_mamba.pth")
